...
data = pd.read_csv(f'{cities[city-1]}-temp-rains.csv')

print(f"The case of {cities[city-1]}\n--_--_--_--_--_--_--_--_--_--_--_--")
...
plt.title(f'{cities[city-1]} climate', fontsize=16)
plt.xlabel('Year', fontsize=12)
